    ...
    <div className="mt-20 flex items-center justify-center">
      <div className="glass-card relative w-full max-w-235 overflow-hidden px-10 py-12">
        <div className="flex gap-8">
          {/* Icon */}
          <div className="size-22 shrink-0 rounded-2xl flex items-center justify-center bg-linear-to-br from-[hsl(263_83%_63%)]/30 to-[hsl(190_96%_52%)]/20 border border-[hsl(263_83%_63%)]/20 shadow-[0_0_20px_rgba(139,92,246,0.2)]">
          ...
          <div className="flex flex-1 flex-col">
            ...
            {/* Description */}
            <div className="mt-6">
              <p className="mb-8 max-w-162.5 leading-relaxed text-[#AAA3C2]">
